...
var adminApiPaths = require('@mocks-server/admin-api-paths');
...
class ApiClient {
    constructor() {
        ...
        Object.defineProperty(this, "_protocol", {
            ...
            configurable: true,
            writable: true,
            value: adminApiPaths.DEFAULT_PROTOCOL
        });
    ...
    get _baseUrl() {
        return `${this._protocol}://${this._host}:${this._port}${adminApiPaths.BASE_PATH}`;
    }
    _fullUrl(apiPath) {
    ...
    config(configuration = {}) {
        ...
        if (!isUndefined(configuration.https)) {
            this._protocol = configuration.https ? adminApiPaths.HTTPS_PROTOCOL : adminApiPaths.DEFAULT_PROTOCOL;
        }
    ...
    read(apiPath) {
        return crossFetch__default["default"](this._fullUrl(apiPath), this._addAgent()).then(handleResponse);
    }
    patch(apiPath, data) {
        return crossFetch__default["default"](this._fullUrl(apiPath), this._addAgent({
            method: "PATCH",
